...
export const ProjectDetail = () => {
  ...
  const findings = useMemo(() => data?.findings ?? project?.findings ?? [], [data?.findings, project?.findings])
