...
export const Register = () => {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.error?.message || 'فشل إنشاء الحساب')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-primary/70 text-primary-foreground p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center items-start max-w-md">
          ...
          >
            ابدأ في حماية أصولك الرقمية اليوم مع أكثر من 15 محرك تحقق متقدم
          </motion.p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">املأ النموذج أدناه لبدء رحلتك مع AegisScan</p>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        errors.first_name && 'border-destructive focus:ring-destructive'
                      )}
                      placeholder="أحمد"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cn(
                        'w-full pl-10 pr-4 py-3 bg-input border border-border rounded-lg',
                        'focus:outline-none focus:ring-2 focus:ring-ring',
                        errors.last_name && 'border-destructive focus:ring-destructive'
                      )}
                      placeholder="العلي"
                    />
                  </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      'w-full pl-10 pr-4 py-3 bg-input border border-border rounded-lg',
                      'focus:outline-none focus:ring-2 focus:ring-ring',
                      errors.password_confirm && 'border-destructive focus:ring-destructive'
                    )}
                    placeholder="••••••••"
                  />
                </div>
                {errors.password_confirm && <p className="mt-1 text-sm text-destructive">{errors.password_confirm.message}</p>}
              </div>
