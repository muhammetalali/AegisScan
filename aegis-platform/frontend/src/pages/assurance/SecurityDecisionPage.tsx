...
interface Payload {
  decisions: Decision[]
  summary: { total: number; critical: number; high: number; requiresInvestigation: number; executivePriority: number; actionable: number }
}
