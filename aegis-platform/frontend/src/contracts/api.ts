...
export const AttackPathNodeSchema = z.object({
  ...
  open_finding_weight: z.number().nonnegative(),
...
export const ComplianceValidationItemSchema = z.object({
  id: z.string(),
  framework: z.string(),
  control: z.string(),
...
export const TwinScenarioSimulationSchema = z.object({
  contract_version: z.literal('1.0'),
  scenario_id: z.string(),
  status: z.string(),
  deterministic: z.boolean(),
  source: z.literal('postgresql'),
  pre_change_risk: z.number().nonnegative(),
  post_change_risk: z.number().nonnegative(),
