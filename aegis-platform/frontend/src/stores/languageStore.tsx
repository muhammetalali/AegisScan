...
const CATALOGS: Record<Language, Catalog> = {
  ...
  en: {
    ...
    'Sign in': 'Sign in', 'Email address': 'Email address', Password: 'Password', Show: 'Show', Hide: 'Hide', 'Show password': 'Show password', 'Hide password': 'Hide password', 'Signing in…': 'Signing in…', 'Signed in successfully': 'Signed in successfully', 'Unable to sign in. Check your credentials and try again.': 'Unable to sign in. Check your credentials and try again.', 'Authenticated access to the security validation platform.': 'Authenticated access to the security validation platform.', 'Protected session': 'Protected session',
  },
}
