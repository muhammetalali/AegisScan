...
export const useAuthStore = create<AuthState>()(persist((set, get) => ({
  ...
  logout: async () => {
    ...
    try {
      ...
      // Local cleanup must always happen even if the server-side blacklist fails.
    } finally {
      clearAuthorization()
      set({
        user: null,
  ...
  forgotPassword: async (email) => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to send reset email' })
      throw error
    }
  },
  ...
  resetPassword: async (token, password) => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to reset password' })
      throw error
    }
  },
  ...
  verifyEmail: async (token) => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to verify email' })
      throw error
    }
  },
  ...
  resendVerification: async () => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to resend verification' })
      throw error
    }
  },
  ...
  updateProfile: async (data) => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to update profile' })
      throw error
    }
  },
  ...
  changePassword: async (oldPassword, newPassword) => {
    ...
    try {
      ...
      set({ loading: false, error: error.response?.data?.detail || error.message || 'Failed to change password' })
      throw error
    }
  },
