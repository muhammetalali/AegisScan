...
class TenantProject(models.Model):
    organization = models.OneToOneField(Organization, on_delete=models.CASCADE, related_name='primary_project_link', null=True, blank=True)
...
class TwinNode(models.Model):
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['twin', 'kind'])]


class TwinRelationship(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    twin = models.ForeignKey(DigitalTwin, on_delete=models.CASCADE, related_name='relationships')
    source = models.ForeignKey(TwinNode, on_delete=models.CASCADE, related_name='outgoing')
    target = models.ForeignKey(TwinNode, on_delete=models.CASCADE, related_name='incoming')
...
class TwinScenario(models.Model):
    ...
    baseline_risk = models.FloatField(null=True, blank=True)
    predicted_risk = models.FloatField(null=True, blank=True)
    risk_delta = models.FloatField(null=True, blank=True)
...
class ReportSchedule(models.Model):
    ...
    report_type = models.CharField(max_length=30, default='full')
...
class FindingIntelligence(models.Model):
    ...
    nvd = models.JSONField(default=dict, blank=True)
    osv = models.JSONField(default=dict, blank=True)
    cisa_kev = models.JSONField(default=dict, blank=True)
    epss = models.JSONField(default=dict, blank=True)
...
class AttackPath(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='attack_paths')
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, related_name='attack_paths')
...
class ComplianceMapping(models.Model):
    assessment = models.ForeignKey('compliance.ComplianceAssessment', on_delete=models.CASCADE, related_name='automatic_mappings')
    vulnerability = models.ForeignKey('vulnerabilities.Vulnerability', on_delete=models.CASCADE, related_name='compliance_mappings')
...
class ExecutiveSnapshot(models.Model):
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='executive_snapshots')
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, related_name='executive_snapshots')
    ...
    source_scan = models.ForeignKey('scans.Scan', on_delete=models.SET_NULL, null=True, blank=True)
    captured_at = models.DateTimeField(auto_now_add=True)


class ContinuousAssuranceSchedule(models.Model):
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='assurance_schedules')
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, related_name='assurance_schedules')
...
class CloudDiscoveryRun(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='cloud_discovery_runs')
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, related_name='cloud_discovery_runs')
...
class SBOMArtifact(models.Model):
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='sboms')
    project = models.ForeignKey('projects.Project', on_delete=models.CASCADE, related_name='sboms')
...
class SBOMComponent(models.Model):
    artifact = models.ForeignKey(SBOMArtifact, on_delete=models.CASCADE, related_name='components')
    name = models.CharField(max_length=300)
    version = models.CharField(max_length=200, blank=True)
    ecosystem = models.CharField(max_length=100, blank=True)
