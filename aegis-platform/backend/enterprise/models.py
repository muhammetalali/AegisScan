...
class WSTGMethodologyAttestation(models.Model):
    """Immutable Enterprise/AGOM methodology-completion attestation.

    This record is methodology governance only; it never represents a vulnerability
    pass/fail verdict or Finding lifecycle decision.
    """
