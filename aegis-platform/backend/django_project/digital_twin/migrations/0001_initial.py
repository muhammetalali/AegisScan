...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={'ordering': ['-updated_at'], 'constraints': [models.UniqueConstraint(fields=('project', 'name'), name='dt_project_name_uniq')]},
        ),
        migrations.CreateModel(
            ...
            options={'constraints': [models.UniqueConstraint(fields=('twin', 'asset'), name='dt_twin_asset_uniq')], 'indexes': [models.Index(fields=['twin', 'asset'], name='dt_node_twin_asset_idx')]},
        ),
        migrations.CreateModel(
            name='TwinScenario',
            fields=[
