...
class ScanEngine(models.Model):
    class EngineCategory(models.TextChoices):
        ...
        VALIDATION = 'validation', _('Control Validation')
    ...
    category = models.CharField(max_length=20, choices=EngineCategory.choices)
    version = models.CharField(max_length=20, default='1.0.0')
    status = models.CharField(max_length=20, choices=EngineStatus.choices, default=EngineStatus.ACTIVE)
    is_core = models.BooleanField(default=False)
    requires_docker = models.BooleanField(default=False)
