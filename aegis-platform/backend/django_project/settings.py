...
INSTALLED_APPS = [
    ...
    'django_project.projects',
    'django_project.scans',
    'django_project.vulnerabilities',
    'django_project.assets',
    'django_project.compliance',
    'django_project.knowledge',
    'django_project.notifications',
    'django_project.audit',
    'django_project.system',
    'django_project.evidence',
    'django_project.posture',
    'django_project.digital_twin',
    'django_project.intelligence',
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'django_project.users.authentication.CookieJWTAuthentication',
    ...
    'EXCEPTION_HANDLER': 'django_project.core.exceptions.custom_exception_handler',
