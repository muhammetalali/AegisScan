...
INSTALLED_APPS = [
    ...
    'django_project.system', 'django_project.evidence', 'enterprise',
]
...
AUTH_COOKIE_SAMESITE = 'Lax'; AUTH_COOKIE_HTTPONLY = True
AUTH_ACCESS_COOKIE = 'aegis_access'; AUTH_REFRESH_COOKIE = 'aegis_refresh'
SESSION_COOKIE_SECURE = AUTH_COOKIE_SECURE; SESSION_COOKIE_HTTPONLY = True; SESSION_COOKIE_SAMESITE = 'Lax'
CSRF_COOKIE_SECURE = AUTH_COOKIE_SECURE; CSRF_COOKIE_SAMESITE = 'Lax'; CSRF_COOKIE_HTTPONLY = False
if not DEBUG:
