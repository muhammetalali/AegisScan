...
INSTALLED_APPS = [
    ...
    'django_project.core', 'django_project.users', 'django_project.projects', 'django_project.scans', 'django_project.vulnerabilities', 'django_project.assets', 'django_project.compliance', 'django_project.knowledge', 'django_project.notifications', 'django_project.audit', 'django_project.system', 'django_project.evidence', 'django_project.posture', 'django_project.digital_twin',
]
...
CACHES = {'default': {'BACKEND':'django_redis.cache.RedisCache','LOCATION':REDIS_URL,'OPTIONS':{'CLIENT_CLASS':'django_redis.client.DefaultClient','COMPRESSOR':'django_redis.compressors.zlib.ZlibCompressor'},'KEY_PREFIX':'aegis'}}
