...
class OrgCreate(BaseModel):
    ...
    slug: str = Field(min_length=2, max_length=220, pattern=r'^[a-z0-9-]+class TwinCreate(BaseModel):
    project_id: UUID
    name: str
...
class OrgMemberCreate(BaseModel):
    ...
    role: str = Field(default='admin', pattern=r'^(admin|manager|analyst|auditor|viewer)class TwinCreate(BaseModel):
    project_id: UUID
    name: str
class ScenarioCreate(BaseModel):
    name: str
