...
def test_multi_tenant_investigation_and_domain_access_is_isolated():
    ...
    try:
        ...
        for path in (
            f'/api/v1/investigation/projects/{project.id}',
            f'/api/v1/attack-path/projects/{project.id}',
            f'/api/v1/digital-twin/projects/{project.id}/twins',
            f'/api/v1/posture/projects/{project.id}' if False else f'/posture/projects/{project.id}/posture',
        ):
