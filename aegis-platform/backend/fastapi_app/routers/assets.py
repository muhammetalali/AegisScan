...
def _set_asset_authorization(asset_id: str, user_id: str, authorized: bool, reason: str, is_staff: bool, correlation_id: Optional[UUID], expires_at):
    ...
    with transaction.atomic():
        ...
        AssetAuthorization.objects.create(asset=asset, actor_id=user_id, authorized=authorized, target_snapshot=target[:500], reason=reason, correlation_id=effective_correlation, supersedes=latest, expires_at=expiry)
        return asset
