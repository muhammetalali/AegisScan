...
# `/api/v1` is the canonical browser and black-box contract.  Legacy aliases
# remain temporarily available inside FastAPI for compatibility, but every
# operational domain used by the frontend must also be registered below.
