...
app.include_router(scans.router, prefix='/scans', tags=['Scans']); app.include_router(vulnerabilities.router, prefix='/vulnerabilities', tags=['Vulnerabilities']); app.include_router(reports.router, prefix='/reports', tags=['Reports']); app.include_router(assets.router, prefix='/assets', tags=['Assets']); app.include_router(compliance.router, prefix='/compliance', tags=['Compliance']); app.include_router(knowledge.router, prefix='/knowledge', tags=['Knowledge']); app.include_router(digital_twin.router, prefix='/digital-twin', tags=['Digital Twin']); app.include_router(posture.router, prefix='/posture', tags=['Security Posture']); app.include_router(system.router, prefix='/system', tags=['System'])
