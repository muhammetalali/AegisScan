...
# bounding set. Celery then runs as the unprivileged aegis user with only
# CAP_NET_RAW effective/permitted/ambient; NET_ADMIN remains exclusively in
# the scanner_egress namespace owner.
exec capsh \
    --keep=1 \
